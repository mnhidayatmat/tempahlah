    ...
    <div class="ledger">
        ...
        <main class="desk">
            <div class="form-wrap">
                ...
                {{-- Google-first: the fastest way back in for anyone who signed
                     up with Google. Plain link — the server signs a CSRF-safe
                     state in the OAuth redirect (no form needed). --}}
                ...
                <div class="or-sep" aria-hidden="true">
                    <span>{{ $isBM ? 'atau daftar masuk dengan email' : 'or sign in with email' }}</span>
                </div>
