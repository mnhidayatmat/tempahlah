...
<head>
    ...
    @vite(['resources/css/app.css', 'resources/css/booking-public.css', 'resources/js/app.js'])
    {{-- Public layout doesn't load Livewire, so Alpine is pulled standalone from CDN. --}}
